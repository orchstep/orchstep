...
import { useState as useState3, useMemo as useMemo2, useCallback as useCallback3, useRef as useRef3, useEffect as useEffect3 } from "react";
    ...
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 4 }, children: [
          /* @__PURE__ */ jsx("button", { style: btnStyle, onClick: onZoomIn, title: "Zoom In", children: /* @__PURE__ */ jsx(ZoomIn, { size: 14 }) }),
          /* @__PURE__ */ jsx("button", { style: btnStyle, onClick: onZoomOut, title: "Zoom Out", children: /* @__PURE__ */ jsx(ZoomOut, { size: 14 }) }),
          /* @__PURE__ */ jsx("button", { style: btnStyle, onClick: onFitView, title: "Fit View", children: /* @__PURE__ */ jsx(Maximize2, { size: 14 }) }),
          /* @__PURE__ */ jsxs(
            "button",
            {
              style: btnStyle,
              ...
              children: [
                direction === "AUTO" ? /* @__PURE__ */ jsx(Sparkles, { size: 14 }) : direction === "TB" ? /* @__PURE__ */ jsx(ArrowDown, { size: 14 }) : /* @__PURE__ */ jsx(ArrowRight, { size: 14 }),
                /* @__PURE__ */ jsx("span", { style: { fontSize: 11 }, children: direction === "AUTO" ? "Smart" : direction === "TB" ? "Vertical" : "Horizontal" })
              ]
            }
          ),
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              children: allCollapsed ? /* @__PURE__ */ jsx(ChevronsUpDown, { size: 14 }) : /* @__PURE__ */ jsx(ChevronsDownUp, { size: 14 })
            }
          )
        ] }),
        /* @__PURE__ */ jsx("div", { style: { flex: 1, display: "flex", justifyContent: "center" }, children: searchOpen ? /* @__PURE__ */ jsx(
          "input",
          {
            ref: inputRef,
            type: "text",
        ...
        ) : /* @__PURE__ */ jsxs("button", { style: btnStyle, onClick: () => setSearchOpen(true), title: "Search", children: [
        ...
        /* @__PURE__ */ jsxs("div", { style: { display: "flex", gap: 4 }, children: [
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsx(Map2, { size: 14 })
            }
          ),
          /* @__PURE__ */ jsx(
            "button",
            {
              ...
              children: theme === "light" ? /* @__PURE__ */ jsx(Moon, { size: 14 }) : /* @__PURE__ */ jsx(Sun, { size: 14 })
            }
          ),
          /* @__PURE__ */ jsx("button", { style: btnStyle, onClick: onExport, title: "Export PNG", children: /* @__PURE__ */ jsx(Download, { size: 14 }) }),
          /* @__PURE__ */ jsx("button", { style: btnStyle, onClick: onCopy, title: "Copy to Clipboard", children: /* @__PURE__ */ jsx(Copy, { size: 14 }) })
        ] })
      ]
    }
  );
...
function Section({
  ...
  const [collapsed, setCollapsed] = useState2(defaultCollapsed ?? false);
  return /* @__PURE__ */ jsxs2("div", { style: { borderBottom: "1px solid var(--panel-border, #e0e0e0)", padding: "10px 16px" }, children: [
    /* @__PURE__ */ jsxs2(
      "div",
      {
        style: {
        ...
        children: [
          collapsible && (collapsed ? /* @__PURE__ */ jsx2(ChevronRight, { size: 14, color: "var(--text-secondary, #888)" }) : /* @__PURE__ */ jsx2(ChevronDown, { size: 14, color: "var(--text-secondary, #888)" })),
          /* @__PURE__ */ jsx2("span", { style: { fontSize: 11, fontWeight: 600, textTransform: "uppercase", color: "var(--text-secondary, #888)", letterSpacing: "0.05em" }, children: title })
        ]
      }
    ),
    !collapsed && /* @__PURE__ */ jsx2("div", { style: { marginTop: 6 }, children })
  ] });
}
function KV({ label, value }) {
  return /* @__PURE__ */ jsxs2("div", { style: { display: "flex", gap: 8, marginBottom: 4, fontSize: 13 }, children: [
    /* @__PURE__ */ jsx2("span", { style: { color: "var(--text-secondary, #888)", minWidth: 80, flexShrink: 0 }, children: label }),
    /* @__PURE__ */ jsx2("span", { style: { color: "var(--text-primary, #111)", wordBreak: "break-word" }, children: String(value) })
  ] });
}
function KeyValueList({ record }) {
  return /* @__PURE__ */ jsx2("div", { children: Object.entries(record).map(([k, v]) => /* @__PURE__ */ jsx2(KV, { label: k, value: JSON.stringify(v) }, k)) });
}
function PanelContent({ node }) {
  const m = node.metadata;
  return /* @__PURE__ */ jsxs2(Fragment, { children: [
    m.description && /* @__PURE__ */ jsx2(Section, { title: "Description", children: /* @__PURE__ */ jsx2("div", { style: { fontSize: 13, color: "var(--text-primary, #111)" }, children: m.description }) }),
    m.command && /* @__PURE__ */ jsx2(Section, { title: "Command", children: /* @__PURE__ */ jsx2("pre", { style: { fontSize: 12, fontFamily: "monospace", background: "var(--canvas-bg, #fafafa)", padding: 8, borderRadius: 4, overflow: "auto", margin: 0, color: "var(--text-primary, #111)" }, children: m.command }) }),
    m.condition && /* @__PURE__ */ jsx2(Section, { title: "Condition", children: /* @__PURE__ */ jsx2("code", { style: { fontSize: 12, color: "var(--text-primary, #111)" }, children: m.condition }) }),
    m.variables && Object.keys(m.variables).length > 0 && /* @__PURE__ */ jsx2(Section, { title: "Variables", collapsible: true, defaultCollapsed: false, children: /* @__PURE__ */ jsx2(KeyValueList, { record: m.variables }) }),
    m.with && Object.keys(m.with).length > 0 && /* @__PURE__ */ jsx2(Section, { title: "Parameters", collapsible: true, defaultCollapsed: false, children: /* @__PURE__ */ jsx2(KeyValueList, { record: m.with }) }),
    m.outputs && Object.keys(m.outputs).length > 0 && /* @__PURE__ */ jsx2(Section, { title: "Outputs", collapsible: true, defaultCollapsed: false, children: /* @__PURE__ */ jsx2(KeyValueList, { record: m.outputs }) }),
    (m.timeout || m.retry) && /* @__PURE__ */ jsxs2(Section, { title: "Resilience", children: [
      m.timeout && /* @__PURE__ */ jsx2(KV, { label: "Timeout", value: m.timeout }),
      m.totalTimeout && /* @__PURE__ */ jsx2(KV, { label: "Total Timeout", value: m.totalTimeout }),
      m.retry && /* @__PURE__ */ jsxs2(Fragment, { children: [
        /* @__PURE__ */ jsx2(KV, { label: "Max Attempts", value: m.retry.maxAttempts }),
        m.retry.interval && /* @__PURE__ */ jsx2(KV, { label: "Interval", value: m.retry.interval }),
        m.retry.backoffRate && /* @__PURE__ */ jsx2(KV, { label: "Backoff Rate", value: m.retry.backoffRate }),
        m.retry.maxDelay && /* @__PURE__ */ jsx2(KV, { label: "Max Delay", value: m.retry.maxDelay }),
        m.retry.jitter != null && /* @__PURE__ */ jsx2(KV, { label: "Jitter", value: m.retry.jitter }),
        m.retry.when && /* @__PURE__ */ jsx2(KV, { label: "When", value: m.retry.when })
      ] })
    ] }),
    m.loopConfig && /* @__PURE__ */ jsxs2(Section, { title: "Loop Config", children: [
      m.loopConfig.items && /* @__PURE__ */ jsx2(KV, { label: "Items", value: m.loopConfig.items }),
      m.loopConfig.count != null && /* @__PURE__ */ jsx2(KV, { label: "Count", value: m.loopConfig.count }),
      m.loopConfig.range && /* @__PURE__ */ jsx2(KV, { label: "Range", value: `${m.loopConfig.range[0]}..${m.loopConfig.range[1]}` }),
      m.loopConfig.as && /* @__PURE__ */ jsx2(KV, { label: "As", value: m.loopConfig.as }),
      m.loopConfig.until && /* @__PURE__ */ jsx2(KV, { label: "Until", value: m.loopConfig.until }),
      m.loopConfig.delay && /* @__PURE__ */ jsx2(KV, { label: "Delay", value: m.loopConfig.delay }),
      m.loopConfig.onError && /* @__PURE__ */ jsx2(KV, { label: "On Error", value: m.loopConfig.onError })
    ] }),
    (m.catch || m.finally || m.onError) && /* @__PURE__ */ jsxs2(Section, { title: "Error Handling", children: [
      m.onError && /* @__PURE__ */ jsx2(KV, { label: "On Error", value: m.onError }),
      m.catch && /* @__PURE__ */ jsx2(KV, { label: "Has Catch", value: "yes" }),
      m.finally && /* @__PURE__ */ jsx2(KV, { label: "Has Finally", value: "yes" })
    ] }),
    (m.moduleName || m.moduleSource) && /* @__PURE__ */ jsxs2(Section, { title: "Module", children: [
      m.moduleName && /* @__PURE__ */ jsx2(KV, { label: "Name", value: m.moduleName }),
      m.moduleSource && /* @__PURE__ */ jsx2(KV, { label: "Source", value: m.moduleSource })
    ] }),
    m.taskRef && /* @__PURE__ */ jsx2(Section, { title: "Task Reference", children: /* @__PURE__ */ jsx2(KV, { label: "Task", value: m.taskRef }) }),
    m.yamlSnippet && /* @__PURE__ */ jsx2(Section, { title: "Raw YAML", collapsible: true, defaultCollapsed: true, children: /* @__PURE__ */ jsx2("pre", { style: { fontSize: 11, fontFamily: "monospace", background: "var(--canvas-bg, #fafafa)", padding: 8, borderRadius: 4, overflow: "auto", margin: 0, maxHeight: 200, color: "var(--text-primary, #111)" }, children: m.yamlSnippet }) })
  ] });
}
function PanelHeader({ node, onClose, onToggleMode, mode }) {
  ...
  return /* @__PURE__ */ jsxs2("div", { style: {
    ...
    /* @__PURE__ */ jsx2(Icon, { size: 18, color }),
    ...
    /* @__PURE__ */ jsx2(
      "button",
      {
        ...
        children: mode === "sidebar" ? /* @__PURE__ */ jsx2(MessageSquare, { size: 14 }) : /* @__PURE__ */ jsx2(PanelRightClose, { size: 14 })
      }
    ),
    /* @__PURE__ */ jsx2(
      "button",
...
function DetailPanel({ node, mode, onClose, onToggleMode, clickPosition }) {
  if (mode === "sidebar") {
    return /* @__PURE__ */ jsxs2("div", { style: {
      ...
      /* @__PURE__ */ jsx2(PanelHeader, { node, onClose, onToggleMode, mode }),
      /* @__PURE__ */ jsx2(PanelContent, { node })
    ] });
  }
...
import { useMemo, useCallback as useCallback2, useEffect as useEffect2, useImperativeHandle, forwardRef } from "react";
import {
  ReactFlow,
  ReactFlowProvider,
  Background,
...
function NodeHandles() {
  return /* @__PURE__ */ jsxs3(Fragment2, { children: [
    /* @__PURE__ */ jsx3(Handle, { type: "target", position: Position.Top, id: "top", style: handleStyle }),
    /* @__PURE__ */ jsx3(Handle, { type: "target", position: Position.Right, id: "right-target", style: handleStyle }),
    /* @__PURE__ */ jsx3(Handle, { type: "target", position: Position.Bottom, id: "bottom-target", style: handleStyle }),
    /* @__PURE__ */ jsx3(Handle, { type: "target", position: Position.Left, id: "left-target", style: handleStyle }),
    /* @__PURE__ */ jsx3(Handle, { type: "source", position: Position.Top, id: "top-source", style: handleStyle }),
    /* @__PURE__ */ jsx3(Handle, { type: "source", position: Position.Right, id: "right", style: handleStyle }),
    /* @__PURE__ */ jsx3(Handle, { type: "source", position: Position.Bottom, id: "bottom", style: handleStyle }),
    /* @__PURE__ */ jsx3(Handle, { type: "source", position: Position.Left, id: "left", style: handleStyle })
  ] });
}
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs4("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
          ...
          /* @__PURE__ */ jsxs4("div", { children: [
            ...
            /* @__PURE__ */ jsx4("div", { style: { fontSize: 13, color: "var(--text-primary, #111)" }, children: data.label })
          ] })
        ] })
      ]
    }
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs5(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsx5(FolderOpen2, { size: 14, color: "#333" }),
              /* @__PURE__ */ jsx5("span", { style: { fontSize: 9, fontWeight: 700, textTransform: "uppercase", color: "var(--text-secondary, #666)" }, children: "Task" }),
              /* @__PURE__ */ jsx5("span", { style: { fontSize: 13, fontWeight: 600, color: "var(--text-primary, #111)", flex: 1 }, children: data.label }),
              onToggleCollapse && /* @__PURE__ */ jsx5("span", { style: { fontSize: 12, color: "#999" }, children: collapsed ? "\u25B8" : "\u25BE" })
            ]
          }
        ),
        collapsed && /* @__PURE__ */ jsxs5("div", { style: { padding: "8px 10px", fontSize: 12, color: "var(--text-secondary, #888)" }, children: [
          stepCount,
          " steps (collapsed)"
        ] }),
        /* @__PURE__ */ jsx5(
...
import { GitFork as GitFork2 } from "lucide-react";
    ...
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs6("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
          /* @__PURE__ */ jsx6(GitFork2, { size: 16, color }),
          /* @__PURE__ */ jsxs6("div", { children: [
            /* @__PURE__ */ jsx6("div", { style: { fontSize: 13, color: "var(--text-primary, #111)" }, children: data.label }),
            data.metadata.condition && /* @__PURE__ */ jsx6(
              "div",
              {
                style: {
                  fontSize: 11,
...
function LoopNode({ data, selected }) {
  ...
  return /* @__PURE__ */ jsxs7(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx7(NodeHandles, {}),
        /* @__PURE__ */ jsxs7("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
          /* @__PURE__ */ jsx7(RefreshCw2, { size: 16, color }),
          /* @__PURE__ */ jsxs7("div", { children: [
            /* @__PURE__ */ jsx7("div", { style: { fontSize: 13, color: "var(--text-primary, #111)" }, children: data.label }),
            loopInfo && /* @__PURE__ */ jsx7(
              "div",
              {
                style: {
                  fontSize: 11,
...
function ModuleCallNode({ data, selected }) {
  ...
  return /* @__PURE__ */ jsxs8(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsx8(NodeHandles, {}),
        /* @__PURE__ */ jsxs8("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
          /* @__PURE__ */ jsx8(Package2, { size: 16, color }),
          /* @__PURE__ */ jsxs8("div", { children: [
            /* @__PURE__ */ jsx8("div", { style: { fontSize: 13, color: "var(--text-primary, #111)" }, children: data.label }),
            data.metadata.moduleName && /* @__PURE__ */ jsx8(
              "div",
              {
                style: {
                  fontSize: 11,
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs9("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
          ...
          /* @__PURE__ */ jsxs9("div", { children: [
            ...
            /* @__PURE__ */ jsx9("div", { style: { fontSize: 13, color: "var(--text-primary, #111)" }, children: data.label })
          ] })
        ] })
      ]
    }
...
function MergeDotNode() {
  return /* @__PURE__ */ jsx10(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsx10(NodeHandles, {})
    }
  );
}
...
function CustomEdge({
  ...
  return /* @__PURE__ */ jsxs10(Fragment3, { children: [
    ...
    label && labelStyle && /* @__PURE__ */ jsx11(EdgeLabelRenderer, { children: /* @__PURE__ */ jsx11(
      "div",
      {
        style: {
          position: "absolute",
...
var GraphInner = forwardRef(function GraphInner2({
  nodes,
  edges,
  direction,
  theme,
  ...
  const remapEdges = useCallback2((flowNodesList) => {
  ...
  const onNodeClick = useCallback2(
    (event, node) => {
  ...
  return /* @__PURE__ */ jsxs11(
    ReactFlow,
    {
      ...
      children: [
        /* @__PURE__ */ jsx12(FlowControls, { ref, direction }),
        /* @__PURE__ */ jsx12(Background, { gap: 16, size: 1 }),
        minimapVisible && /* @__PURE__ */ jsx12(
          MiniMap,
          {
            nodeStrokeWidth: 3,
...
var WorkflowGraph = forwardRef(
  function WorkflowGraph2(props, ref) {
    return /* @__PURE__ */ jsx12(ReactFlowProvider, { children: /* @__PURE__ */ jsx12(GraphInner, { ref, ...props }) });
  }
);
...
function WorkflowViewer({
  ...
  const [direction, setDirection] = useState3(initialDirection);
  const [theme, setTheme] = useState3(initialTheme);
  const [selectedNode, setSelectedNode] = useState3(null);
  const [searchQuery, setSearchQuery] = useState3("");
  const [minimapVisible, setMinimapVisible] = useState3(false);
  const [collapsedTasks, setCollapsedTasks] = useState3(/* @__PURE__ */ new Set());
  const [toast, setToast] = useState3(null);
  const [panelMode, setPanelMode] = useState3("float");
  const [clickPosition, setClickPosition] = useState3({ x: 0, y: 0 });
  const graphRef = useRef3(null);
  const parseResult = useMemo2(() => parseWorkflowYaml(yaml), [yaml]);
  ...
  const handleNodeSelect = useCallback3(
    (node, clickPos) => {
  ...
  const showToast = useCallback3((msg) => {
    setToast(msg);
  ...
  const handleToggleTask = useCallback3((taskId) => {
  ...
  return /* @__PURE__ */ jsxs12(
    "div",
    {
      ...
      children: [
        ...
        errors.length > 0 && /* @__PURE__ */ jsx13(
          "div",
          {
            style: {
              padding: "8px 16px",
            ...
            children: errors.map((e, i) => /* @__PURE__ */ jsx13("div", { children: e.message }, i))
          }
        ),
        warnings.length > 0 && /* @__PURE__ */ jsx13(
          "div",
          {
            style: {
              padding: "8px 16px",
            ...
            children: warnings.map((w, i) => /* @__PURE__ */ jsx13("div", { children: w.message }, i))
          }
        ),
        interactive && /* @__PURE__ */ jsx13(
          Toolbar,
          {
            direction,
            theme,
        ...
        hasNodes ? /* @__PURE__ */ jsxs12("div", { style: { flex: 1, position: "relative" }, children: [
          /* @__PURE__ */ jsx13(
            WorkflowGraph,
            {
              ref: graphRef,
