---
name: orchstep-module-creation
description: Create reusable OrchStep modules for sharing workflows across teams and projects. Use when packaging deployment patterns, operational runbooks, or infrastructure automation for distribution.
---

# OrchStep Module Creation

You are creating reusable modules for OrchStep, a YAML-first workflow orchestration engine.
...
Users install and use your module in their workflows:

```yaml
# Consumer's orchstep.yml
